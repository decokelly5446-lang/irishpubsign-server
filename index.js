...
// ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ROUTES ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
...
// Preview route ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ generates and returns composite image without placing order
...
// Tool route ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ personalisation engine
...
app.get('/success', (req, res) => {
    ...
    <title>Order Confirmed ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ IrishPubSign.com</title>
    ...
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    <body>
    <div class="card">
      <span class="shamrock">ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ</span>
        <h1>Order Confirmed!</h1>
          <p>Your personalised Irish pub sign is on its way to print. You'll receive a confirmation email shortly.</p>
            <div class="order-note">
                <p>Produced and shipped within 3ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ5 working days ÃÂÃÂÃÂÃÂ· Delivered worldwide</p>
                  </div>
                    <p style="font-size:0.9rem;">Questions? Email us at <a href="mailto:orders@irishpubsign.com" style="color:#C9A84C;">orders@irishpubsign.com</a></p>
                      <a href="/" class="btn">Order Another ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ</a>
                      </div>
                      </body>
                      </html>`);
});
...
require('dotenv').config();require('dotenv').config();require('dotenv').config();undefinedrequire('dotenv').config();
const express = require('express');
const stripe = require('stripe')(process.env.STRIPE_SECRET_KEY);
const path = require('path');
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ ROUTES ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
app.use('/api', require('./routes/checkout'));
app.use('/webhook', require('./routes/webhooks'));
...
// Preview route ÃÂ¢ÃÂÃÂ generates and returns composite image without placing order
app.get('/preview', async (req, res) => {
      const { name, est, pub } = req.query;
      if (!name || !pub) {
              return res.status(400).send('Missing required parameters: name, pub');
...
// Tool route ÃÂ¢ÃÂÃÂ personalisation engine
app.get('/tool', (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'tool.html'));
});
...
app.get('/success', (req, res) => {
    ...
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Order Confirmed ÃÂ¢ÃÂÃÂ IrishPubSign.com</title>
    <link href="https://fonts.googleapis.com/css2?family=Uncial+Antiqua&family=Crimson+Pro:ital,wght@0,400;0,600;1,400&display=swap" rel="stylesheet">
    <style>
    * { margin:0; padding:0; box-sizing:border-box; }
    body { background:#0D0A06; color:#F2ECD8; font-family:'Crimson Pro',Georgia,serif; min-height:100vh; display:flex; align-items:center; justify-content:center; padding:2rem; }
    ...
    <body>
    <div class="card">
      <span class="shamrock">ÃÂ¢ÃÂÃÂ</span>
        <h1>Order Confirmed!</h1>
          <p>Your personalised Irish pub sign is on its way to print. You'll receive a confirmation email shortly.</p>
            <div class="order-note">
                <p>Produced and shipped within 3ÃÂ¢ÃÂÃÂ5 working days ÃÂÃÂ· Delivered worldwide</p>
                  </div>
                    <p style="font-size:0.9rem;">Questions? Email us at <a href="mailto:orders@irishpubsign.com" style="color:#C9A84C;">orders@irishpubsign.com</a></p>
                      <a href="/" class="btn">Order Another ÃÂ¢ÃÂÃÂ</a>
                      </div>
                      </body>
                      </html>`);
});
...
// Ã¢ÂÂÃ¢ÂÂ ROUTES Ã¢ÂÂÃ¢ÂÂ
app.use('/api', require('./routes/checkout'));
app.use('/webhook', require('./routes/webhooks'));
...
// Preview route Ã¢ÂÂ generates and returns composite image without placing order
app.get('/preview', async (req, res) => {
      const { name, est, pub } = req.query;
      if (!name || !pub) {
              return res.status(400).send('Missing required parameters: name, pub');
...
// Tool route Ã¢ÂÂ personalisation engine
app.get('/tool', (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'tool.html'));
});
...
app.get('/success', (req, res) => {
    ...
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Order Confirmed Ã¢ÂÂ IrishPubSign.com</title>
    <link href="https://fonts.googleapis.com/css2?family=Uncial+Antiqua&family=Crimson+Pro:ital,wght@0,400;0,600;1,400&display=swap" rel="stylesheet">
    <style>
    * { margin:0; padding:0; box-sizing:border-box; }
    body { background:#0D0A06; color:#F2ECD8; font-family:'Crimson Pro',Georgia,serif; min-height:100vh; display:flex; align-items:center; justify-content:center; padding:2rem; }
    ...
    <body>
    <div class="card">
      <span class="shamrock">Ã¢ÂÂ</span>
        <h1>Order Confirmed!</h1>
          <p>Your personalised Irish pub sign is on its way to print. You'll receive a confirmation email shortly.</p>
            <div class="order-note">
                <p>Produced and shipped within 3Ã¢ÂÂ5 working days ÃÂ· Delivered worldwide</p>
                  </div>
                    <p style="font-size:0.9rem;">Questions? Email us at <a href="mailto:orders@irishpubsign.com" style="color:#C9A84C;">orders@irishpubsign.com</a></p>
                      <a href="/" class="btn">Order Another Ã¢ÂÂ</a>
                      </div>
                      </body>
                      </html>`);
});
...
// Preview route â generates and returns composite image without placing order
app.get('/preview', async (req, res) => {
      const { name, est, pub } = req.query;
      if (!name || !pub) {
              return res.status(400).send('Missing required parameters: name, pub');
...
// Tool route â personalisation engine
app.get('/tool', (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'tool.html'));
});
...
app.get('/success', (req, res) => {
    ...
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Order Confirmed â IrishPubSign.com</title>
    <link href="https://fonts.googleapis.com/css2?family=Uncial+Antiqua&family=Crimson+Pro:ital,wght@0,400;0,600;1,400&display=swap" rel="stylesheet">
    <style>
    * { margin:0; padding:0; box-sizing:border-box; }
    body { background:#0D0A06; color:#F2ECD8; font-family:'Crimson Pro',Georgia,serif; min-height:100vh; display:flex; align-items:center; justify-content:center; padding:2rem; }
    ...
    <body>
    <div class="card">
      <span class="shamrock">â</span>
        <h1>Order Confirmed!</h1>
          <p>Your personalised Irish pub sign is on its way to print. You'll receive a confirmation email shortly.</p>
            <div class="order-note">
                <p>Produced and shipped within 3â5 working days Â· Delivered worldwide</p>
                  </div>
                    <p style="font-size:0.9rem;">Questions? Email us at <a href="mailto:orders@irishpubsign.com" style="color:#C9A84C;">orders@irishpubsign.com</a></p>
                      <a href="/" class="btn">Order Another â</a>
                      </div>
                      </body>
                      </html>`);
});
